function criarJogo(boardId, barraId, bolaId, controles) {
    ...
    function atualizar() {
        ...
        if (bolaY > board.clientHeight - 1) {
            ...
            document.getElementById("popup-message").textContent = `Você perdeu, mas fez ${pontuacao} pontos :D`;
        }
...
// Função para reiniciar a página ao clicar nos botões do popup (usada no HTML)
window.reiniciar = function() { location.reload(); };
